...
class Net_ves_nocoords_nearFourier(nn.Module):
    def __init__(self, num_blocks, factor, ch):
        super(Net_ves_nocoords_nearFourier, self).__init__()
        self.factor = factor
        self.ch = ch
...
# model = pdeNet_Ves_fat_factor_Fourier_nocoords(num_blocks=14, factor=1.0, ch=40)
# summary(model, (2, 128))
