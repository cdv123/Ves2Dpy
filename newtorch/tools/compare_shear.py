...
files = [
    "Verification/TwoVesicles/pararealVesNet/oneIter2e5_5e6TwoCore.bin",
    "Verification/TwoVesicles/pararealVesNet/oneIter1e5_5e6TwoCore.bin",
    "Verification/TwoVesicles/pararealVesNet/oneIter3e5_5e6TwoCore.bin",
    "Verification/TwoVesicles/pararealVesNet/oneIter5e6_5e6TwoCore.bin",
]
...
compare_files(
    ...
    strides,
    labels=[
        "Coarse dt=2e-5, fine dt=5e-6",
        "Coarse dt=1e-5, fine dt=5e-6",
        "Coarse dt=3e-5, fine dt=5e-6",
        "Coarse dt=5e-5, fine dt=5e-6",
    ],
)
