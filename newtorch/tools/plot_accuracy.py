...
plot_errors(
    "Verification/OneVesicle/pararealVesNet/oneIter1e5_5e6.bin",
    "Verification/OneVesicle/groundTruth.bin",
    label="coarse dt=1e-5, fine dt=5e-6",
    ax_center=ax_c,
    ax_angle=ax_a,
    ground_stride=5,
)
...
plot_errors(
    ...
    "Verification/OneVesicle/groundTruth.bin",
    label="coarse dt=2e-5, fine dt=1e-5",
    ax_center=ax_c,
    ax_angle=ax_a,
    ground_stride=10,
)
plot_errors(
    "Verification/OneVesicle/pararealVesNet/oneIter5e5_1e5.bin",
    "Verification/OneVesicle/groundTruth.bin",
    label="coarse dt=5e-5, fine dt=1e-5",
    ax_center=ax_c,
    ax_angle=ax_a,
    ground_stride=10,
)
plot_errors(
    "Verification/OneVesicle/pararealVesNet/oneIter1e5_1e6.bin",
    "Verification/OneVesicle/groundTruth.bin",
    label="coarse dt=1e-5, fine dt=1e-6",
    ax_center=ax_c,
    ax_angle=ax_a,
    ground_stride=10,
)
